...
//        val password = accountManager.getPassword(account)
        ...
        val intent = Intent(context, AuthenticationManager::class.java).apply {
            putExtra(AccountManager.KEY_ACCOUNT_AUTHENTICATOR_RESPONSE, response)
            putExtra(AuthenticationManager.ARG_ACCOUNT_TYPE, account?.type)
            putExtra(AuthenticationManager.ARG_AUTH_TYPE, authTokenType)
            putExtra(AuthenticationManager.ARG_ACCOUNT_NAME, account?.name)
        }
